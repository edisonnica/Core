...
{
    public class RateOfChange : IndicatorBase, Interfaces.Indicators.RateOfChange
    {
        ...
        public RateOfChange(int period, TimeSpan barSize, DataStream stream, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Roc(_tavalues.ToArray(), Period);
