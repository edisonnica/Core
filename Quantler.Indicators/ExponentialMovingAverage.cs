...
{
    public class ExponentialMovingAverage : IndicatorBase, Interfaces.Indicators.ExponentialMovingAverage
    {
        ...
        public ExponentialMovingAverage(int period, TimeSpan barSize, DataStream stream, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Ema(_tavalues.ToArray(), Period);
