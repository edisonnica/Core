...
{
    public class DirectionalIndex : IndicatorBase, Interfaces.Indicators.AverageDirectionalIndex
    {
        ...
        public DirectionalIndex(int period, DataStream stream, TimeSpan barSize)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Dx(_high.ToArray(), _low.ToArray(), _close.ToArray(), Period);
