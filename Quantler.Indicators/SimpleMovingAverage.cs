...
{
    public class SimpleMovingAverage : IndicatorBase, Interfaces.Indicators.SimpleMovingAverage
    {
        ...
        public SimpleMovingAverage(int period, TimeSpan barSize, DataStream stream, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Sma(_tavalues.ToArray(), Period);
