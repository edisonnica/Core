...
{
    public class WeightedMovingAverage : IndicatorBase, Interfaces.Indicators.WeightedMovingAverage
    {
        ...
        public WeightedMovingAverage(int period, TimeSpan barSize, DataStream stream, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Wma(_tavalues.ToArray(), Period);
