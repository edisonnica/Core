...
{
    public class ChandeMomentumOscillator : IndicatorBase, Interfaces.Indicators.ChandeMomentumOscillator
    {
        ...
        public ChandeMomentumOscillator(int period, TimeSpan barSize, DataStream stream, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.ChandeMomOsc(_tavalues.ToArray(), Period);
