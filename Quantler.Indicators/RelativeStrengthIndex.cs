...
{
    public class RelativeStrengthIndex : IndicatorBase, Interfaces.Indicators.RelativeStrengthIndex
    {
        ...
        public RelativeStrengthIndex(int period, DataStream stream, TimeSpan barSize, Func<Bar, decimal> comp = null)
        {
        ...
        public override void OnBar(Bar bar)
        {
            ...
            var calced = _ta.Rsi(_tavalues.ToArray(), Period);
